...
var { targetController, routeController } = require('./controllers')
...
router.set('/api/targets', {
  GET: (req, res, opts) => targetController.getAllTargets(req, res, opts),
  POST: (req, res, opts) => targetController.addTarget(req, res, opts)
})

router.set('/api/target/:id', {
  GET: (req, res, opts) => targetController.getTargetById(req, res, opts),
  POST: (req, res, opts) => targetController.updateTarget(req, res, opts)
})

router.set('/route', {
  POST: (req, res, opts) => routeController.visiterRouteDecision(req, res, opts)
})
